...
public class BootDataJPAProj2PagingAndSortingRepoApplication {
	
	public static void main(String[] args) {
		ApplicationContext ctxt = SpringApplication.run(BootDataJPAProj2PagingAndSortingRepoApplication.class, args);
